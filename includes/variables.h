...
#define BUFF_SIZE 120  //BUFFER TO JOIN UART BYTES RECEIVED
#define UART_BUF_SIZE 120
#define PRIORITY -1
...
#define DELAY_RTY K_MSEC(20000)
#define RETRY 20
#define LIMIT_RECONNECT_CNT    10000  // IF THIS LIMIT REACHED, FORCE A RE-JOIN
#define LORAWAN_INTERVAL_NORMAL 60  //INTERVAL BETWEEN UPLOADS IN MINUTES             - MINIMUM 3 MINUTES
...
#ifdef MODULE_1 //MODULO SOLDADO SMT
//DEVICE_EUI
#define LORAWAN_DEV_EUI_HELIUM  {0x60, 0x81, 0xF9, 0x44, 0x0A, 0xFD, 0x54, 0x54}
//APP_EUI
#define LORAWAN_JOIN_EUI_HELIUM {0x60, 0x81, 0xF9, 0x82, 0xBD, 0x7F, 0x80, 0xD5}
//APP_KEY
#define LORAWAN_APP_KEY_HELIUM  {0x40, 0xA3, 0x4B, 0x94, 0x3E, 0x87, 0xD8, 0x38, 0xC2, 0x4F, 0x36, 0xA4, 0xEC, 0xA7, 0x79, 0x03}
#endif


#ifdef MODULE_2 //MODULO SOLDADO SMD
//DEVICE_EUI msb
